...
const offers = [
  {
    ...
    description:
      "A complete meal for your burger cravings. Fresh burger, crispy fries and a chilled drink.",
    price: 249,
    oldPrice: 329,
    discount: "24% OFF",
    category: "Combos",
  ...
  },
  {
    ...
    description:
      "Perfect for sharing. Get your favorite pizza with crispy garlic bread and refreshing drinks.",
    price: 499,
    oldPrice: 649,
    discount: "23% OFF",
    category: "Pizza",
  ...
  },
  {
    ...
    description:
      "The ultimate family meal packed with burgers, pizza, fries and drinks.",
    price: 799,
    oldPrice: 999,
    discount: "20% OFF",
    category: "Family",
  ...
  },
  {
    ...
    badge: "SAVE MORE",
    title: "Burger Duo",
    subtitle: "2 Burgers + 2 Fries",
    description:
      "Double the burgers, double the fun. Great for a quick meal with a friend.",
    price: 399,
    oldPrice: 499,
    discount: "20% OFF",
    category: "Combos",
  ...
  },
  {
    ...
    badge: "CHEESY DEAL",
    title: "Pizza & Drink",
    subtitle: "Medium Pizza + Cold Drink",
    description:
      "Your favorite medium pizza paired with a refreshing chilled drink.",
    price: 299,
    oldPrice: 379,
    discount: "21% OFF",
    category: "Pizza",
  ...
  },
  {
    ...
    badge: "FAMILY PICK",
    title: "Snack Box",
    subtitle: "Fries + Nuggets + Burger + Drink",
    description:
      "Everything you need for a satisfying snack break.",
    price: 349,
    oldPrice: 449,
    discount: "22% OFF",
    category: "Snacks",
...
const filters = ["All", "Combos", "Pizza", "Family", "Snacks"];
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 md:px-8 md:py-16  mt-[60px]">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-sm leading-7 text-white/75 sm:text-base">
              Hungry for a great deal? Explore our latest combos, family
              offers and delicious discounts made for your cravings.
            </p>
          ...
          {[
            {
              icon: Zap,
              title: "Quick Deals",
              text: "Made for cravings",
            },
            {
              icon: Tag,
              title: "Great Value",
              text: "More food, less price",
            },
            {
              icon: CheckCircle2,
              title: "Fresh Food",
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:px-8 md:py-16">
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-[var(--color-text-secondary)]">
              Pick your favorite deal and enjoy more for less.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredOffers.map((offer) => (
            <article
              key={offer.id}
              className="group overflow-hidden rounded-3xl border border-[var(--color-border)] bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(45,27,15,0.12)]"
            >
              {/* Image */}
              ...
              <div className="p-5">
                ...
                <div className="mt-5 flex items-end gap-3">
                  ...
                  <span className="mb-1 text-sm text-[var(--color-text-muted)] line-through">
                    ₹{offer.oldPrice}
                  </span>

                  <span className="mb-1 rounded-full bg-[var(--color-primary-50)] px-2.5 py-1 text-[10px] font-black text-[var(--color-primary)]">
                    {offer.discount}
                  </span>
                </div>
                ...
                <div className="mt-5 flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[var(--color-border)] bg-white text-[var(--color-text-primary)] transition hover:border-[var(--color-primary)] hover:bg-[var(--color-primary-50)] hover:text-[var(--color-primary)]"
                  >
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-3xl bg-[var(--color-secondary)] px-6 py-10 text-center sm:px-10">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-6 text-white/80">
              Check out the complete SFC Cafe menu and find your next
              favorite meal.
            </p>
