...
export default function GoogleSignInButton({
  ...
  return (
    <div className={`relative flex w-full flex-col items-center justify-center ${className}`}>
      ...
      {!isLoaded && (
        <div className="flex h-[44px] w-full max-w-[400px] items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 text-sm font-medium text-gray-700 shadow-xs animate-pulse">
